...
export default class About01 extends Component {
    render() {
        return (
            <div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="listItem">
                            <li><i class="digitos-check"></i>Creative Digital Marketing</li>
                            <li><i class="digitos-check"></i>Creative Digital Campaigns</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="digitosTabWrapper">
                            <ul class="nav digitosTab" id="digitosTab" role="tablist">
